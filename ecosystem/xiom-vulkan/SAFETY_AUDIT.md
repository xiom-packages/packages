...
|---|--------|--------|---------|
| 1 | Resource Lifetime | ✅ PRESENT | — |
| 2 | Multithreaded Rendering | ⚠️ PARTIAL | No thread-safe abstraction, single-queue convenience layer |
| 3 | Memory Management | ⚠️ PARTIAL | No VMA-style sub-allocator, missing bind2/requirements2 |
| 4 | Pipeline Management | ⚠️ PARTIAL | Pipeline cache serialization not in bridge |
| 5 | Descriptor Management | ✅ PRESENT | — |
| 6 | Render Pass Management | ✅ PRESENT | — |
| 7 | Shader Compilation | ❌ MISSING | No GLSL/HLSL→SPIR-V toolchain, no shader reflection |
| 8 | Texture Loading | ❌ MISSING | No image decoders, no automated mipmap pipeline |
| 9 | Synchronization | ✅ PRESENT | — |
| 10 | Frame Pacing | ✅ PRESENT | — |
| 11 | Ray Tracing | ✅ PRESENT | — |
| 12 | GPU-Driven Rendering | ✅ PRESENT | — |
| 13 | Debug Tools | ✅ PRESENT | — |
| 14 | Profiling | ✅ PRESENT | — |
| 15 | Platform Support | ✅ PRESENT | Windows, Linux, macOS, headless |
...
| ID | Gap | Status |
|----|-----|--------|
| CG-01 | Float32/Float64 Vec element reads return garbage (sitofp bug) | ⚠️ Reproduced |
| CG-02 | E001 "use of moved value" on Float64 in math.sin() calls | ⚠️ Cosmetic, workaround exists |
| CG-03 | Cross-module `use xiom.*` catalog doesn't resolve from single file | ⚠️ Multi-file merge works |
| CG-04 | `extern "C"` block at top-level without `module` declaration → P001 parse error | ⚠️ Fixed by adding module declaration |
| CG-05 | `xvk_app_should_close` returns 1 when app handle is valid but window is null (headless) | ⚠️ Design limitation |
