# axiom:imgui — Dear ImGui Bindings

Immediate mode GUI for AXIOM via Dear ImGui (cimgui C wrapper).
...
fn main() -> Int {
  glfw.init()?;
  let window = glfw.create_window(800, 600, "AXIOM ImGui")?;
