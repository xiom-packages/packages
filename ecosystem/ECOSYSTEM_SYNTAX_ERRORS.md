...
|-------|-------------|-------|--------|
| E1 | module-line trailing `;` | 13 | [OK] FIXED |
| E2 | block match arm trailing `,` (+ doc defect) | 9 | [OK] FIXED |
| E3 | `;` in struct literal | 5 | [OK] FIXED |
| E4 | single-expr arm `;` not `,` | 2 | [OK] FIXED |
| E5 | match arm bare assignment | 2 | [OK] FIXED |
| E6 | `let mut` | 1 | [OK] FIXED |
| E7 | `mut` in pattern | 1 | [WIP] pending (xiom-http/src/parser.xi -- also has E8) |
| E8 | `@intrinsic()` syntax | 1-2 | [WIP] pending (deferred: semantic fix to stdlib string API) |
| E9 | `&name` param | 1 | [WIP] pending (xiom-imgui/imgui.xi) |
| E10 | anonymous struct literal | 1 | [WIP] pending (xiom-onnx/src/types.xi) |
| E11 | contract clause trailing `;` | 1 | [WIP] pending (xiom-crypto/src/random.xi) |
| E12 | body-less fn missing `;` | 1 | [WIP] pending (xiom-postgres/postgres.xi) |
| E13 | param-list trailing comma (borderline) | 1 | [OK] FIXED |
| E15 | Rust-style `::` paths | 27 | [OK] FIXED |
| E16 | reserved keyword as field name | 2 | [OK] FIXED (`module` -> `module_name`) |
| E17 | deeper `;`-in-literal (post-E1) | several | [OK] FIXED |
| missing `=>` on match arm | filter_eval, search_service | 2 | [OK] FIXED |
