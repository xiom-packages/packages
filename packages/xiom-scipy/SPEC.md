...
pub fn norm_pdf(x: Float64) -> Float64       // φ(x) = (1/√(2π)) · e^(-x²/2)
pub fn norm_cdf(x: Float64) -> Float64       // Φ(x) via erf series
...
|-------|------|--------|--------|
| 1 | FFI declarations (10 C functions) + pure-XIOM stats + safe wrappers + conformance tests | Weekend | ✅ Implemented |
