...
- **7.3: `xvk_shader_compile.c/h` -- Runtime GLSL->SPIR-V compilation via glslc subprocess** [OK] NEW
...
- **7.5: Multi-thread command pools** [OK] NEW
...
- **7.4: Texture loading pipeline** [OK] NEW
