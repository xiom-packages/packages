// XIOM -- xiom.l10n.number package manifest
// Port task: promote the xiom.l10n.number placeholder to a real, tested,
// pure-XIOM package (scaled-integer formatting, rounding and parsing).
