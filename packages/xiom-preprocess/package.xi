// XIOM -- xiom.preprocess package manifest
// Port task: promote the xiom.preprocess placeholder to a real, tested,
...
// and xiom.string.compare from it; the tests additionally use xiom.test and
// xiom.io.
